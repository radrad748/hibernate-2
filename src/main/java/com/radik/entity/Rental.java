...
public class Rental {
    ...
    public boolean equals(Object o) {
        ...
        if (!Objects.equals(inventory, rental.inventory)) return false;
        if (!Objects.equals(customer, rental.customer)) return false;
        if (!Objects.equals(returnDate, rental.returnDate)) return false;
        return Objects.equals(staff, rental.staff);
    }
